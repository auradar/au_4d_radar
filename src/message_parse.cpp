...
void MessageParser::makeRadarPointCloud2Msg(uint8_t *p_buff, sensor_msgs::msg::PointCloud2& cloud_msg) {
    uint32_t idx = 0;
...
void MessageParser::makeRadarScanMsg(uint8_t *p_buff, radar_msgs::msg::RadarScan& radar_scan_msg) {
    uint32_t idx = 0;
    tsPacketHeader header = {};
    std::stringstream ss;
...
void MessageParser::makeRadarTracksMsg(uint8_t *p_buff, radar_msgs::msg::RadarTracks &radar_tracks_msg) {
    uint32_t idx = 0;
    tsPacketHeader header = {};
    std::stringstream ss;
...
void MessageParser::parsePointCloud2Msg(uint8_t *p_buff, sensor_msgs::msg::PointCloud2& radar_cloud_msg) {
    makeRadarPointCloud2Msg(p_buff, radar_cloud_msg);  
}

void MessageParser::parseRadarScanMsg(uint8_t *p_buff, radar_msgs::msg::RadarScan& radar_scan_msg) {
    makeRadarScanMsg(p_buff, radar_scan_msg);  
}

void MessageParser::parseRadarTrackMsg(uint8_t *p_buff, radar_msgs::msg::RadarTracks& radar_tracks_msg) {
    makeRadarTracksMsg(p_buff, radar_tracks_msg);  
}
